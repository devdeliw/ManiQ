...
class CircuitUpdate: 
    ...
    Updated ManiQ Circuit --> Updated DataFrame --> Updated QuantumCircuit Instructions 
...
circuit_data = pd.read_csv('/Users/devaldeliwala/maniq/circuit/sandbox.csv')

qc = CircuitUpdate(circuit_data).instruction_to_circuit()
